...
func CreateCompany(c *fiber.Ctx) error {
	...
	company := company_models.Company{
		Name:                      req.Name,
		ForeignBranchName:         req.ForeignBranchName,
		ForeignRegistrationNumber: req.ForeignRegistrationNumber,
...
func GetCompanyResponse(company company_models.Company) dtos.CompanyResponse {
	return dtos.CompanyResponse{
		...
		AuthorityName:             company.AuthorityName,
		AuthorityNumber:           company.AuthorityNumber,
		LocalAddress:              company.LocalAddress,
		ForeignAddress:            company.ForeignAddress,
		ForeignBranchName:         company.ForeignBranchName,
		ForeignRegistrationNumber: company.ForeignRegistrationNumber,
